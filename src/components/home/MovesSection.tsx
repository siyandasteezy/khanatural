      ...
      <Container>
        <div className="grid items-center gap-10 lg:grid-cols-[420px_1fr] lg:gap-16">
          ...
          <div>
            ...
            {/* Original copy, minus the clause pointing at the retired WhatsApp line. */}
            <p className="mt-5 max-w-xl text-base leading-relaxed text-ink/75 sm:text-lg">
              Khanatural Moves your body, mind &amp; soul. Book your ‘online or in-person’ session by dropping us an email.
            </p>
